...
import com.sg.SuperHeroSightings.Dao.LocationDaoJDBCImpl.LocationMapper;
import com.sg.SuperHeroSightings.Dao.SuperDaoJDBCImpl.SuperMapper;
...
public class SightingDaoJDBCImpl implements SightingDao {
    ...
    public void updateSighting(Sighting sighting) {
      jdbc.update(UPDATE_SIGHTING, sighting.getSightingDate().toString(), sighting.getSightingSuper().getSuperID(),
                sighting.getSightingLocation().getLocationID(), sighting.getSightingID());
    }
